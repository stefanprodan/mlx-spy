...
// usage asked for on the last frame, no prompt_cache_key (the prefix
// cache key is an mlx-serve concept; OpenRouter caches per upstream on
// its own and reports cached_tokens).
